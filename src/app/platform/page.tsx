...
/**
 * Platform Page
 * EXACT implementation from designer-src/src/app/components/Platform.tsx
 * 
 * Sections in order:
 * 1. Hero Section - Split layout with headline + 3 feature cards
 * 2. Powered by HAGI Section - Dark background with features grid
 * 3. Tabbed Platform Capabilities
 * 4. Solution Modules - Horizontal scrolling cards
 * 5. Analytics & Insights
 * 6. Value Proposition (Why It Matters)
 * 7. Final CTA
 */
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            >
              <p className="text-[17px] text-[#06003F]/70 leading-relaxed mb-8">
                One secure, agentic AI platform that automates voice, fax, and web-driven
                administrative work — with analytics and orchestration built in.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 z-10">
                ...
                <p className="text-[13px] text-white/70">
                  Autonomous phone conversations with payers
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 z-10">
                ...
                <p className="text-[13px] text-white/70">
                  Automated portal navigation and data entry
                </p>
              </div>
            </motion.div>
          </div>
            ...
            >
              <div>
                <p className="text-[16px] text-white/60 leading-relaxed mb-8">
                  At the core of our platform is Healthcare Administration General Intelligence — a
                  purpose-built agentic AI architecture that plans, acts, and learns from real-world
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.08]">
            {hagiFeatures.map((feature, idx) => (
              ...
              >
                ...
                <p className="text-[14px] text-white/60 leading-relaxed">{feature.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 mb-12">
            ...
            >
              <p className="text-[16px] text-[#06003F]/70 leading-relaxed">
                Create with our production-grade agentic AI models and industry-leading automation
          ...
          <div className="grid md:grid-cols-[300px_1fr] gap-12">
            ...
            <div className="flex flex-col gap-3">
              {capabilities.map((cap, index) => (
                ...
                >
                  <cap.icon
                    className={`w-5 h-5 ${activeTab === cap.id ? 'text-[#FF4E3A]' : 'text-[#06003F]/40'}`}
                  />
                ...
                (cap) =>
                  activeTab === cap.id && (
                    ...
                    >
                      ...
                      <p className="text-[16px] text-[#06003F]/80 leading-relaxed mb-8">
                        {cap.description}
                      </p>
      ...
      <section className="relative py-24 bg-[#FAFAFA]">
        <div className="container mx-auto px-6 md:px-16 max-w-7xl">
          <div className="grid md:grid-cols-2 gap-16 mb-12">
            ...
            >
              <p className="text-[16px] text-[#06003F]/70 leading-relaxed">
                Explore automated solutions designed for critical healthcare revenue cycle workflows
                — from benefit verification to claims management.
              </p>
            </motion.div>
          </div>
                ...
                {solutions.map((solution, index) => (
                  ...
                  >
                    ...
                    <div className="relative w-32 h-32 mx-auto mb-6">
                      <div
                        className={`absolute inset-0 rounded-full bg-gradient-to-br ${solution.gradient} opacity-80 blur-xl`}
                      />
                      <div
                        className={`relative w-full h-full rounded-full bg-gradient-to-br ${solution.gradient} flex items-center justify-center`}
                      >
        ...
        <div className="container mx-auto px-6 md:px-16 max-w-7xl">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-[16px] text-[#06003F]/70 leading-relaxed">
                Transform raw conversation data into actionable intelligence with structured
                summaries, drill-down metrics, and operational dashboards.
              </p>
            </motion.div>
            ...
            >
              <div className="bg-[#FAFAFA] rounded-[12px] p-6 border border-[#06003F]/5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-[16px] font-bold text-[#06003F] mb-2">
          ...
          >
            <div className="text-center mb-20">
              ...
              <p className="text-[17px] text-[#06003F]/60 max-w-2xl mx-auto leading-relaxed">
                Transform your healthcare revenue cycle operations with intelligent automation that
      ...
      <section className="relative py-32 overflow-hidden bg-[#06003F]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            ...
            style={{
              background:
                'radial-gradient(circle, rgba(255, 78, 58, 0.4) 0%, rgba(255, 78, 58, 0.1) 40%, transparent 70%)',
              filter: 'blur(80px)',
            }}
          />
          ...
          <motion.div
            ...
            style={{
              background:
                'radial-gradient(circle, rgba(138, 43, 226, 0.35) 0%, rgba(138, 43, 226, 0.15) 40%, transparent 70%)',
              filter: 'blur(90px)',
            }}
          />
          ...
          <motion.div
            ...
            style={{
              background:
                'radial-gradient(circle, rgba(255, 105, 180, 0.3) 0%, rgba(255, 105, 180, 0.1) 40%, transparent 70%)',
              filter: 'blur(100px)',
            }}
          />
